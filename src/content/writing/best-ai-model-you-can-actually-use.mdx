...
This is not a professional benchmark. It is just what I noticed while using these tools for coding, projects, presentations, studying, and writing.
...
For my needs, it has been pretty bad. The problem is not just that I dislike the interface or prefer another brand. It is that when I try to use it for real work, it usually gives me something half-done. For coding, I trust GPT or Claude more. For project planning, Gemini does not feel as sharp. For presentations, the output is usually too shallow for what I need.

Maybe it is good at images or video. I do not want to judge it too much there because that is not my main use case. I mostly need these tools for coding, project work, presentations, and studying. In those areas, Gemini usually feels weaker than the others.

## NotebookLM

The one exception is NotebookLM.

NotebookLM is probably the only part of Gemini that I really like. For exams that require memorization, it has genuinely helped me. The podcast feature is great because it turns study material into something I can listen to. That actually changes how I study.

The video presentation feature was less impressive. The results felt too short and too shallow. Maybe useful as a quick overview, but not enough if I need something detailed.
...
The important part is that Claude often edits things properly. It writes code, changes structure, and gives me something I can keep working on. NotebookLM sometimes gives presentation-like outputs too, but when something is wrong, fixing it takes too much time. Claude feels much easier to direct.
...
For coding, I tried Claude, Copilot, and GPT inside VS Code. That is where I am comparing them from, not from random prompts in a chat window.
...
For agentic work, especially non-academic projects like this site or game projects, I started making small systems to save context. On this site, for example, I have an `AGENTS.md` file that tells coding agents the rules of the project. It explains what the site is, which folders matter, what should not be changed, and what checks need to pass before a task is finished.
...
Claude is the best when I need documents and presentations.

GPT is the best when I need long coding sessions without constantly worrying about limits.

Gemini is mostly disappointing, but NotebookLM is genuinely useful for studying.

Copilot depends too much on which models are available this week.

And after trying all of them, I keep coming back to one idea.
